      ...
      <div onClick={(e) => e.target.href ? setMobilMenu(false) : false} className={s.headerMobileContainer}>
         <div className={s.contentContainer}>
            <div className={s.itemContainer} onClick={(e) => e.target.id ? setActiveID(e.target.id) : setActiveID(false)}>
               ...
               <div id='councilDeputies' className={`mt24 ${s.item}`}>Совет депутатов <div className={s.imgContainer}><img src={arrow_down} alt="" /></div></div>
               <NavLink to={ROUTER.documents} /* id='history' */ className={`mt24 ${s.item}`}>Документы <div className={s.imgContainer}><img src={arrow_down} alt="" /></div></NavLink>
               <NavLink to={ROUTER.news} /* id='khimkiDistrict' */ className={`mt24 ${s.item}`}>Новости <div className={s.imgContainer}><img src={arrow_down} alt="" /></div></NavLink>
               <div /* id='activity' */ className={`mt24 ${s.item}`}> Интернет-ресурсы <div className={s.imgContainer}><img src={arrow_down} alt="" /></div></div>
         ...
         <div className={`${s.dropDownMenu} ${activeID && s.active}`}>
            ...
            <div className={` ${activeID === 'councilDeputies' && s.linkMenuContainerActive} ${s.linkMenuContainer}`}>
