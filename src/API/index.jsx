...
const API = {
   ...
   end_point: async (data) => {
      return axios.get(`https://admhimki.ru/end_point.php`, data)
         .then(response => {
   ...
   delaraEnd_point: async (data) => {
      return axios.get(`https://admhimki.ru/delara/end_point.php`, data)
         .then(response => {
   ...
   delaraPublicEnd_point: async (data) => {
      return axios.get(`https://admhimki.ru/delara/public/end_point.php`, data)
         .then(response => {
